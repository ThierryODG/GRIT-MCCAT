...
@section('content')
    <div class="container px-4 py-6 mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-1 text-gray-600">Vérifiez et validez les recommandations soumises par les structures (statut:
                <strong>plan_soumis_ig</strong>)
            </p>
        </div>
                                    ...
                                    <div class="flex items-start justify-between mb-2">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <span
                                                ...
                                                {{ $recommandation->plans_action_count ?? $recommandation->plansAction->count() }}
                                                plan(s)
                                            </span>
                                            <span
                                ...
                                ($recommandation->priorite == 'moyenne' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800') }}">
                                    ...
                                    <div class="mt-3 space-y-1 text-sm text-gray-500">
                                        <p>
                                            ...
                                            {{ optional($recommandation->pointFocal)->name ?? 'Non assigné' }}
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            ...
                                            {{ $recommandation->date_limite?->format('d/m/Y') ?? 'Non spécifié' }}
                                    ...
                                    <div class="flex justify-end mt-4">
                                        <a href="{{ route('inspecteur_general.plan_actions.recommandation_dossier', $recommandation) }}"
        ...
        @else
            ...
            <div class="py-12 text-center bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <p class="mt-1 text-sm text-gray-500">Les recommandations apparaîtront ici lorsque les points focaux auront
                    soumis leur travail.</p>
            </div>
        @endif
    </div>
