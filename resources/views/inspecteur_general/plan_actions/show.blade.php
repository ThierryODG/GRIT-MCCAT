    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="space-y-6">
            ...
            <div class="p-6 bg-white border border-gray-200 rounded-xl">
                ...
                <div class="space-y-4">
                            <!-- Validation -->
                            <form action="{{ route('inspecteur_general.plan_actions.validate', $planAction) }}" method="POST">
                        @csrf
                        <div class="mb-4">
                    ...
                    <!-- Rejet -->
                    <form action="{{ route('inspecteur_general.plan_actions.validate', $planAction) }}" method="POST" id="rejectForm">
                        @csrf
                        <div class="mb-4">
