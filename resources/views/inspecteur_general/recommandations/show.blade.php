        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <span
                                        class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium {{ $config['bg'] }} {{ $config['text'] }}">
                        ...
                        @if($recommandation->contexte)
                            <div>
                                ...
                                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 min-h-[100px]">
                                    <p class="leading-relaxed text-gray-900 whitespace-pre-line">{{ $recommandation->contexte }}
                                    </p>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($recommandation->objectif)
                            <div>
                                ...
                                <div class="p-4 bg-green-50 rounded-lg border border-green-200 min-h-[100px]">
                                    <p class="leading-relaxed text-gray-900 whitespace-pre-line">{{ $recommandation->objectif }}
                                    </p>
                                </div>
                            </div>
                        @endif
            ...
            <div class="space-y-6">
                ...
                @if($recommandation->statut === 'soumise_ig')
                    <div class="bg-white border border-gray-200 shadow-sm rounded-xl">
                        <div
                            class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-50 to-emerald-50 rounded-t-xl">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <!-- Rejet -->
                            <form action="{{ route('inspecteur_general.recommandations.rejeter', $recommandation) }}"
                                method="POST">
                                @csrf
                                <div class="mb-4">
                                    <label class="block mb-2 text-sm font-medium text-red-700">Motif du rejet <span
                ...
                @if($recommandation->statut !== 'soumise_ig')
                    <div class="bg-white border border-gray-200 shadow-sm rounded-xl">
                        <div
                            class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-blue-gray-50 rounded-t-xl">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span
                                        class="text-sm text-gray-900">{{ $recommandation->date_validation_ig->format('d/m/Y H:i') }}</span>
                                </div>
