    ...
    <div class="p-6 mb-6 bg-white border border-gray-100 rounded-lg shadow-sm">
        <form method="GET" class="grid grid-cols-1 gap-6 md:grid-cols-4">
            <div>
                ...
                <select name="statut" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    <option value="">Tous les statuts</option>
                    <option value="soumise_ig" {{ request('statut') == 'soumise_ig' ? 'selected' : '' }}>En attente</option>
            ...
            <div>
                ...
                <select name="priorite" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
                ...
                <select name="structure_id" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="flex items-end space-x-3">
                <button type="submit" class="flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200 bg-gray-50/80">
                        <th class="px-6 py-4 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Référence</th>
                        <th class="px-6 py-4 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Titre</th>
                        <th class="px-6 py-4 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Inspecteur ITS</th>
                        <th class="px-6 py-4 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Priorité</th>
                        <th class="px-6 py-4 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase">Date</th>
                    ...
                    <tr class="transition-colors duration-150 hover:bg-blue-50/30">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <span class="text-sm font-medium text-gray-900">{{ $recommandation->reference }}</span>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="max-w-xs">
                                <div class="text-sm font-semibold text-gray-900 truncate">{{ $recommandation->titre }}</div>
                                <div class="mt-1 text-sm text-gray-500 line-clamp-2">{{ $recommandation->description }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <div class="text-sm font-medium text-gray-900">{{ $recommandation->its->name ?? 'N/A' }}</div>
                                    @if($recommandation->its->structure ?? false)
                                    <div class="text-xs text-gray-500">{{ $recommandation->its->structure->nom ?? '' }}</div>
                                    @endif
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center text-gray-400">
                                ...
                                <p class="mt-1 text-sm text-gray-400">Aucune recommandation ne correspond à vos critères de recherche</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
