                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <select id="priorite" name="priorite" required
                            ...
                            <option value="haute" {{ old('priorite') == 'haute' ? 'selected' : '' }} class="font-medium text-red-600">🔴 Haute priorité</option>
                            <option value="moyenne" {{ old('priorite') == 'moyenne' ? 'selected' : '' }} class="font-medium text-yellow-600">🟡 Priorité moyenne</option>
                            <option value="basse" {{ old('priorite') == 'basse' ? 'selected' : '' }} class="font-medium text-green-600">🟢 Priorité basse</option>
                        </select>
                        @error('priorite')
                            <p class="flex items-center mt-2 text-sm text-red-600">
                                <i class="mr-1 fas fa-exclamation-circle"></i>
