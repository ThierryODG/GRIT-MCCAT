...
@section('content')
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Indicateurs</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($recommandation->plansAction as $action)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500">{{ Str::limit($action->indicateurs, 30) }}</td>
    ...
    <!-- Modal Rappel -->
    <div id="modal-rappel" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" aria-hidden="true" onclick="document.getElementById('modal-rappel').classList.add('hidden')"></div>
                    ...
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Envoyer un rappel</h3>
                                <div class="mt-2">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="destinataire" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                            @if($recommandation->pointFocal)
                                            ...
                                            @endif
                                            @if($recommandation->inspecteurGeneral)
                                                <option value="inspecteur_general">Inspecteur Général ({{ $recommandation->inspecteurGeneral->name }})</option>
                                            @endif
                                        </select>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Message (Optionnel)</label>
                                        <textarea name="message" rows="3" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" placeholder="Message personnalisé..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
