...
<aside class="flex flex-col w-64 h-screen bg-white border-r border-gray-200 shadow-xl">
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('admin.structures.index') }}"
            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.structures.*') ? 'bg-indigo-50 text-indigo-600 shadow-sm border-l-4 border-indigo-600' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="flex-shrink-0 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
            </svg>
            <span class="font-medium">Structures</span>
        </a>
