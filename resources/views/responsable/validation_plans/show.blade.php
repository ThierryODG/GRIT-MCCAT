        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="space-y-6 lg:col-span-2">
                ...
                <div class="p-6 bg-white border border-gray-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                                <p class="text-gray-700 whitespace-pre-wrap">
                                    {{ $planAction->recommandation->indicateurs ?? 'Non spécifié' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700">Responsable de l'exécution</label>
                        <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                            @if($planAction->executant_type === 'autre')
                                <p class="text-gray-900 font-medium">{{ $planAction->executant_nom }}</p>
                                @if($planAction->executant_role)
                                    <p class="text-sm text-gray-500">{{ $planAction->executant_role }}</p>
                                @endif
                            @else
                                <p class="text-gray-900 font-medium">Point Focal
                                    ({{ $planAction->pointFocal->name ?? 'Moi-même' }})</p>
                            @endif
                        </div>
                    </div>
            ...
            <div class="p-6 bg-white border border-gray-200 rounded-xl">
                ...
                <!-- Pièces jointes -->
                <div class="p-6 bg-white border border-gray-200 rounded-xl">
                    <h2 class="mb-4 text-lg font-semibold text-gray-900">Pièces Jointes de la Recommandation</h2>
                    @if($planAction->recommandation->documents && $planAction->recommandation->documents->count() > 0)
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            @foreach($planAction->recommandation->documents as $doc)
                                <div
            ...
            <div class="space-y-6">
                ...
                <div class="p-6 bg-white border border-gray-200 rounded-xl">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Rejet -->
                        <form action="{{ route('responsable.validation_plans.rejeter', $planAction) }}" method="POST"
                            id="rejectForm">
                            @csrf
                            <div class="mb-4">
                ...
                <div class="p-6 bg-white border border-gray-200 rounded-xl">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-medium text-gray-900">{{ $planAction->pointFocal->name ?? 'Non assigné' }}
                                </p>
